    ...
    <div ref={containerRef} className="relative">
      ...
      {open && (
        <div className="absolute left-full bottom-0 ml-2.5 z-50 w-[220px]">
          <div className="bg-white rounded-xl shadow-[0px_4px_16px_rgba(0,0,0,0.12)] border border-[#e5e5e5] py-2 overflow-hidden">
            {/* Header */}
            <div className="px-3 py-2">
              <p
                className="font-['Ubuntu_Sans',sans-serif] text-[11px] leading-[16px] text-[#9caeb8] uppercase tracking-wider"
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col items-start min-w-0">
                    <span
                      className="font-['Ubuntu_Sans',sans-serif] text-[13px] leading-[18px] text-[#1b2124] truncate w-full text-left"
                      style={{ fontWeight: isActive ? 600 : 400 }}
                    >
                      {role.name}
                    </span>
                    <span
                      className="font-['Ubuntu_Sans',sans-serif] text-[11px] leading-[16px] text-[#4d595e] truncate w-full text-left"
                    >
                      {role.label}
                    </span>
                  </div>
