        ...
        {coordActivities.map((activity, index) => (
          <div key={index} className="flex gap-4 pb-2">
            <div className="flex flex-col items-center shrink-0">
              ...
              {index < coordActivities.length - 1 && <div className="w-px flex-1 bg-[#e5e5e5] mt-2 rounded" />}
            </div>
            <div className="flex-1 flex flex-col gap-2 pb-2 min-w-0">
              <div className="h-8 flex items-center">
                <p className="font-['Ubuntu_Sans',sans-serif] text-[16px] leading-[26px] text-[#1b2124]" style={{ fontWeight: 700 }}>
                  {activity.title}
                </p>
              </div>
        ...
        <div className="flex flex-col gap-3">
          {caseStatusData.map((item, i) => {
            ...
            return (
              ...
              >
                <span
                  className="font-['Ubuntu_Sans',sans-serif] text-[13px] leading-[18px] text-[#4d595e] shrink-0"
