...
import workspaceSvg from "../../imports/svg-8oo5o2i4y5";
import navSvg from "../../imports/svg-ta501kkcky";
import logoImg from "figma:asset/fbd36fcfddc0be317eea5f288eb64c23f7e11ae5.png";
...
export function Sidebar({ activeRole, onRoleChange, currentView, onNavigate }: { activeRole: RoleId; onRoleChange: (role: RoleId) => void; currentView?: string; onNavigate?: (view: string) => void }) {
  ...
  return (
    <div className="flex flex-col items-center bg-white border-r border-[#e5e5e5] w-[52px] h-full shrink-0">
      {/* Logo */}
      ...
      <div className="w-[37px] h-px bg-[#e5e5e5] my-1" />
        ...
        <div className="flex flex-col gap-1 items-center relative">
          ...
          <SidebarTooltip label="Add Workspace">
            <div className="flex items-center justify-center p-[4px] rounded-[6px] relative cursor-pointer hover:bg-[#f5f5f5]">
              <div className="absolute border border-[#e5e5e5] inset-0 pointer-events-none rounded-[6px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.04)]" />
        ...
        <div className="absolute left-full top-1/2 -translate-y-1/2 ml-2.5 z-50 pointer-events-none">
          <div className="relative flex items-center">
            ...
            <div className="bg-[#1b2124] text-white rounded-md px-2.5 py-1 whitespace-nowrap shadow-lg">
              <span
                className="font-['Ubuntu_Sans',sans-serif] text-[12px] leading-[16px]"
