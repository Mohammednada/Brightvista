      ...
      <div className="relative w-full">
        ...
        >
          <div style={{ minWidth: 640 }}>
            {/* Table Header */}
            <div className="bg-[#f7fafc] rounded-t-lg py-2">
              <div className="flex items-center">
                <StickyIdCell bg="#f7fafc" className="pl-4">
                  <span
                    className="font-['Ubuntu_Sans',sans-serif] text-[14px] leading-[18px] text-[#1b2124]"
            ...
            {coordinators.map((coord, index) => (
              <div key={coord.id} className="group/row">
                <div className="flex items-center py-1 transition-colors group-hover/row:bg-[#fafbfc]">
                  ...
                  >
                    <span className="font-['Ubuntu_Sans',sans-serif] text-[14px] leading-[22px] text-[#4d595e]">
                      {coord.id}
                    </span>
                  </StickyIdCell>
                  {/* Name - Sticky */}
                  ...
                  >
                    <span
                      className="font-['Ubuntu_Sans',sans-serif] text-[14px] leading-[18px] text-[#3385f0] cursor-pointer hover:underline"
                      style={{ fontWeight: 500 }}
                    >
                      {coord.name}
                    </span>
                    <span className="font-['Ubuntu_Sans',sans-serif] text-[12px] leading-[18px] text-[#4d595e]">
                      {coord.joinDate}
                    </span>
                  </StickyNameCell>
                  {/* Specialty */}
                  <div className="w-[100px] shrink-0 pl-2">
                    <span className="font-['Ubuntu_Sans',sans-serif] text-[14px] leading-[22px] text-[#1b2124]">
                      {coord.specialty}
                    </span>
                  </div>
                  {/* Cases */}
                  <div className="w-[110px] shrink-0 px-3 flex flex-col gap-1 relative">
                    <span
                      className="font-['Ubuntu_Sans',sans-serif] text-[12px] leading-[14px] tracking-[1px] uppercase"
                      style={{ fontWeight: 700, color: coord.casesColor }}
                    >
                      {coord.cases}
                    </span>
                    <div className="flex items-center rounded-lg overflow-visible bg-[#f7fafc] border border-white h-2">
                      {(() => {
                            ...
                            >
                              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover/segment:flex flex-col items-center z-50 pointer-events-none">
                                <div className="bg-[#1b2124] text-white rounded-md px-2.5 py-1.5 whitespace-nowrap shadow-lg flex items-center gap-1.5">
                                  ...
                                  <span className="font-['Ubuntu_Sans',sans-serif] text-[11px] leading-[14px] text-[#9caeb8]">
                                    {count}
                                  </span>
                                </div>
                  ...
                  <div className="w-[86px] shrink-0 flex justify-end">
                    <span
                      className="inline-flex items-center px-1 py-0.5 rounded-full border border-[rgba(9,159,105,0.48)] text-[12px] leading-[14px] text-[#099f69] font-['Ubuntu_Sans',sans-serif]"
                      style={{ fontWeight: 500 }}
                    >
                      {coord.systemAccess}
                    </span>
                  ...
                  <div className="flex-1 flex items-center justify-end gap-2 px-2 pr-4">
                    ...
                    <span
                      className="font-['Ubuntu_Sans',sans-serif] text-[14px] leading-[22px] text-[#4d595e]"
                      style={{ fontWeight: 700 }}
                    >
