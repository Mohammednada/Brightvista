  ...
  return (
    ...
    >
      <svg width="16" height="20" viewBox="0 0 16 20" fill="none">
        <path d="M1 1L1 15.5L5.5 11.5L9 19L12 17.5L8.5 10L14 9.5L1 1Z" fill="#1F425F" stroke="white" strokeWidth="1.2" />
      </svg>
      <motion.div
        className="absolute left-4 top-4 bg-[#1F425F] rounded-full px-1.5 py-0.5"
        initial={{ opacity: 0 }}
        animate={{ opacity: [0, 1, 1, 0] }}
        transition={{ duration: 1.5, repeat: Infinity, times: [0, 0.1, 0.8, 1] }}
      >
        <span className="text-white text-[6px]" style={{ fontWeight: 600 }}>Agent</span>
      </motion.div>
    </motion.div>
  );
}
      ...
      <div className="h-[36px] bg-[#0f2440] flex items-center justify-between px-3 shrink-0">
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-white/90 text-[10px]" style={{ fontWeight: 600 }}>Hyperspace</span>
          </div>
            ...
            <div className="flex items-center gap-1 ml-2">
              {breadcrumbs.map((bc, i) => (
                <span key={i} className="flex items-center gap-1">
                  ...
                  <span className={`text-[9px] ${i === breadcrumbs.length - 1 ? "text-white/80" : "text-white/40"}`} style={{ fontWeight: i === breadcrumbs.length - 1 ? 500 : 400 }}>
                    {bc}
                  </span>
                </span>
              ))}
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="w-[18px] h-[18px] rounded-full bg-[#4da8da] flex items-center justify-center">
            <span className="text-white text-[7px]" style={{ fontWeight: 600 }}>NS</span>
          </div>
        </div>
      </div>
          ...
          {sidebarNav.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                <span className={`text-[7px] ${isActive || isHighlight ? "text-white/90" : "text-white/35"}`} style={{ fontWeight: isActive ? 600 : 400 }}>
                  {item.label}
                </span>
              </motion.div>
            );
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[340px] bg-[#0f2440] gap-5">
      <div className="flex flex-col items-center gap-2">
        ...
        <span className="text-white/90 text-[13px]" style={{ fontWeight: 600 }}>Hyperspace</span>
    ...
    <div className="flex h-[340px]">
      <div className="w-[180px] bg-gradient-to-b from-[#0f2440] to-[#1a3a5c] flex flex-col items-center justify-center p-5 gap-4 shrink-0">
        ...
        <div className="flex flex-col items-center gap-1">
          <span className="text-white/90 text-[12px]" style={{ fontWeight: 600 }}>Hyperspace</span>
      ...
      <div className="flex-1 bg-white flex flex-col items-center justify-center px-6 relative">
        ...
        <div className="w-full max-w-[220px]">
          <span className="text-[#1a365d] text-[14px] block mb-4" style={{ fontWeight: 600 }}>Sign in to continue</span>
          <div className="flex flex-col gap-2.5">
            <div>
              <label className="text-[9px] text-[#6b7c93] mb-0.5 block" style={{ fontWeight: 500 }}>Username</label>
            ...
            <div>
              <label className="text-[9px] text-[#6b7c93] mb-0.5 block" style={{ fontWeight: 500 }}>Password</label>
            ...
            <motion.button
              className={`w-full rounded-lg py-2 text-[11px] text-white transition-all ${phase >= 3 ? "bg-[#2563eb] shadow-md shadow-[#2563eb]/20" : "bg-[#a0b4cc]"}`}
    ...
    <EHRLayout activeNav={0} breadcrumbs={["Home", "Dashboard"]}>
      <div className="p-3 h-full overflow-hidden">
        <div className="flex items-center justify-between mb-3">
          <div>
            <span className="text-[13px] text-[#1a365d] block" style={{ fontWeight: 600 }}>Good morning, NorthStar Agent</span>
          ...
          <motion.div className="flex items-center gap-1 bg-[#f0fdf4] border border-[#bbf7d0] rounded-full px-2 py-0.5" animate={{ opacity: [1, 0.6, 1] }} transition={{ duration: 2, repeat: Infinity }}>
            ...
            <span className="text-[8px] text-[#166534]" style={{ fontWeight: 500 }}>Online</span>
          </motion.div>
        </div>
          ...
          {[
            ...
            <div key={label} className="bg-white rounded-lg border border-[#eaedf2] p-2">
              <div className="flex items-center justify-between mb-1">
                <span className="text-[7px] text-[#6b7c93]" style={{ fontWeight: 500 }}>{label}</span>
                <div className="w-4 h-4 rounded flex items-center justify-center" style={{ backgroundColor: bg }}>
                  <Icon size={8} style={{ color }} />
                </div>
              </div>
              <span className="text-[14px] text-[#1a365d]" style={{ fontWeight: 700 }}>{value}</span>
            </div>
          ))}
        </div>
        <div className="bg-white rounded-lg border border-[#eaedf2] p-2">
          <span className="text-[9px] text-[#1a365d] block mb-1.5" style={{ fontWeight: 600 }}>Recent Activity</span>
          {[
  ...
  return (
    <EHRLayout activeNav={0} breadcrumbs={["Home", "Dashboard"]} highlightNav={2}>
      <div className="flex flex-col items-center justify-center h-full gap-3 relative">
        ...
        <span className="text-[12px] text-[#1a365d]" style={{ fontWeight: 500 }}>
    ...
    <EHRLayout activeNav={2} breadcrumbs={["Home", "Patients", "Search"]}>
      <div className="p-3 h-full overflow-hidden relative">
        ...
        <div className="flex items-center justify-between mb-2.5">
          <span className="text-[12px] text-[#1a365d]" style={{ fontWeight: 600 }}>Patient Search</span>
        ...
        <div className={`flex items-center gap-2 bg-white border rounded-lg px-3 py-2 mb-3 transition-colors ${phase >= 1 ? "border-[#4da8da] shadow-sm shadow-[#4da8da]/10" : "border-[#dfe4ea]"}`}>
          ...
          {phase >= 1 && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-[#2563eb] rounded px-1.5 py-0.5">
              <span className="text-white text-[7px]" style={{ fontWeight: 600 }}>Search</span>
            </motion.div>
          )}
        </div>
        <div className="flex items-center gap-1.5 mb-2.5">
          {["All Patients", "Active", "Inactive", "Recent"].map((f, i) => (
            <span key={f} className={`text-[7px] px-2 py-0.5 rounded-full border ${i === 0 ? "bg-[#2563eb] text-white border-[#2563eb]" : "text-[#6b7c93] border-[#e2e8f0]"}`} style={{ fontWeight: 500 }}>
              {f}
            </span>
          ))}
        </div>
        <div className="bg-white rounded-lg border border-[#e2e8f0] overflow-hidden">
          <div className="grid grid-cols-[1.4fr_0.8fr_1fr_1fr_0.6fr] gap-1 px-3 py-1.5 bg-[#f8f9fb] border-b border-[#eef0f4]">
            {["Patient Name", "DOB", "MRN", "Insurance", "Status"].map(h => (
              <span key={h} className="text-[8px] text-[#6b7c93]" style={{ fontWeight: 600 }}>{h}</span>
            ))}
          </div>
          {phase >= 2 ? (
            <>
              <motion.div initial={{ opacity: 0, y: 4 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.25 }} className="grid grid-cols-[1.4fr_0.8fr_1fr_1fr_0.6fr] gap-1 px-3 py-2 bg-[#eff6ff] border-l-[3px] border-[#2563eb]">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] text-[#1a365d]" style={{ fontWeight: 600 }}>Margaret Thompson</span>
                </div>
                ...
                <span className="text-[7px] bg-[#f0fdf4] text-[#166534] px-1.5 py-0.5 rounded-full w-fit" style={{ fontWeight: 500 }}>Active</span>
              </motion.div>
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 0.5 }} transition={{ delay: 0.15 }} className="grid grid-cols-[1.4fr_0.8fr_1fr_1fr_0.6fr] gap-1 px-3 py-2 border-t border-[#f5f6f8]">
                ...
                <span className="text-[7px] bg-[#f5f6f8] text-[#a0aec0] px-1.5 py-0.5 rounded-full w-fit" style={{ fontWeight: 500 }}>Active</span>
              </motion.div>
            </>
          ) : (
      ...
      <div className="h-full overflow-hidden flex flex-col">
        <div className="bg-white border-b border-[#eaedf2] px-3 py-2 flex items-center gap-3 shrink-0">
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#4da8da] to-[#2563eb] flex items-center justify-center shrink-0">
            <span className="text-white text-[11px]" style={{ fontWeight: 700 }}>MT</span>
          </div>
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              <span className="text-[12px] text-[#1a365d]" style={{ fontWeight: 600 }}>Margaret Thompson</span>
              <span className="text-[7px] bg-[#f0fdf4] text-[#166534] px-1.5 py-0.5 rounded-full" style={{ fontWeight: 500 }}>Active</span>
            </div>
          ...
          <motion.div className="flex items-center gap-1 bg-[#eef0ff] rounded-full px-2 py-0.5" animate={{ opacity: [1, 0.6, 1] }} transition={{ duration: 1.5, repeat: Infinity }}>
            ...
            <span className="text-[7px] text-[#6366f1]" style={{ fontWeight: 500 }}>Extracting</span>
          </motion.div>
        </div>
        <div className="bg-white border-b border-[#eaedf2] px-3 flex items-center gap-0 shrink-0">
          {["Demographics", "Insurance", "History", "Documents"].map((tab, i) => (
            <motion.div
              ...
              style={{ fontWeight: (i === 0 && activeTab === 0) || (i === 1 && activeTab >= 1) ? 600 : 400 }}
            >
              {tab}
            </motion.div>
          ))}
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-1 mb-0.5">
                    ...
                    <span className="text-[7px] text-[#6b7c93]" style={{ fontWeight: 500 }}>{field.label}</span>
                  </div>
                  <span className={`text-[10px] ${isHighlighted ? "text-[#166534]" : "text-[#1a365d]"}`} style={{ fontWeight: 600 }}>
                    {field.value}
                  </span>
                </motion.div>
              );
  ...
  return (
    <EHRLayout activeNav={2} breadcrumbs={["Home", "Patients", "Margaret Thompson"]}>
      <div className="flex flex-col items-center justify-center h-full gap-3 bg-gradient-to-b from-[#f0fdf4] to-[#f3f5f8]">
        ...
        >
          <span className="text-[13px] text-[#166534]" style={{ fontWeight: 600 }}>Data Extraction Complete</span>
        ...
        >
          {[
            ...
            <div key={label} className="flex items-center gap-1">
              ...
              <span className="text-[8px] text-[#22c55e] bg-[#f0fdf4] px-1 rounded" style={{ fontWeight: 600 }}>{count}</span>
            </div>
          ))}
        </motion.div>
      </div>
    ...
    >
      ...
      <div className="bg-[#1e1e2e] px-4 py-2.5 flex items-center gap-3">
        ...
        <div className="flex-1 flex items-center gap-2 bg-[#2a2a3e] rounded-lg px-3 py-1.5 mx-2">
          ...
          <span className="font-['Ubuntu_Sans',sans-serif] text-[11px] text-[#a0a0c0] truncate">
            {step.url}
          </span>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1.5">
              ...
              <span
                className="font-['Ubuntu_Sans',sans-serif] text-[11px] text-[#c0c0d8]"
          ...
          <span className="font-['Ubuntu_Sans',sans-serif] text-[10px] text-[#666680] shrink-0">
