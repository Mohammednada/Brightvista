    ...
    <div className="bg-white shrink-0 w-full sticky top-0 z-10 border-b border-border-default">
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-1">
          ...
          >
            <svg className="block size-[18px]" fill="none" viewBox="0 0 17.9167 17.9167">
              <path d={navSvg.p39f7e500} fill={isPanelOpen ? "var(--color-primary-brand)" : "#565656"} />
              <path d={navSvg.p1b36e800} fill={isPanelOpen ? "var(--color-primary-brand)" : "#565656"} />
              <path d={navSvg.p29166a00} fill={isPanelOpen ? "var(--color-primary-brand)" : "#565656"} />
            </svg>
          </button>
        </div>
      </div>
